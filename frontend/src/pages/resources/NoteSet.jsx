...
export default function NoteSet() {
  ...
  const loadPosts = async (page = 1) => {
    ...
    setError(null);
    try {
      const data = await NotesAPI.fetchNotes(page, pageSize);
  ...
  if (loading) return <Spinner fullScreen text="Loading notes..." />;
      ...
      <div className="w-full lg:w-4/6 space-y-4 py-6 px-4">
        ...
        {posts.length > 0 ? (
          ...
          <div className="text-center py-6">
            <p className="text-gray-500">No public notes found.</p>
          </div>
        )}
        {totalPages > 1 && (
          <div className="mt-4">
